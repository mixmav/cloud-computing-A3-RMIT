...
@section('auth-content')
	...
	<form action="/auth/register" method="POST">
		<input type="text" class="text-input full-width" placeholder="Your name" name="name" autofocus="" required>
		<input type="email" class="text-input full-width" placeholder="Email" name="email" required>
